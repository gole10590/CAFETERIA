...
$rentas = $admin->consulta_all_usuarios($_SESSION['id_usuario']);
?>
...
<div class="col-lg-12" >
    <div class="col-lg-3 list-group-flush" >
        ...
        <div class="list-group">    
            ...
            <a href="<?php echo BASEURL . "views/admin/Bloquear_usuarios_fraudulentos.php" ?>" class="list-group-item">Bloquear usuarios fraudulentos</a>
