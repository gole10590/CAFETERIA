                    ...
                    <?php foreach ($rentas as $key => $value) : $id_pro = $rentas[$key]["id_producto"]
                        ...
                        <tr>
                            <td>
                                ...
                                <a type="button" class="btn btn-danger btn-mini" data-toggle="modal" data-target="#<?php echo $rentas[$key]["id_producto"] ?>" >PROCESAR</a>
                            ...
                            <td><?php $status = $rentas[$key]["id_status"]; ?>
                                <?php if ($status == 1) : $stt = 2; ?>
                                    <a data-toggle="tooltip" title="Producto en venta" href="<?php echo "Actualizaciones.php?stt=".$stt."&id=ActStatus&p=" . $id_pro ?>" type="button" class="btn btn-success btn-mini">LISTO!!</a>
                                <?php
                                endif;
                                if ($status == 2) : $stt = 1;
                                    ?>
